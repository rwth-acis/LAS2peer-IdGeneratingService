...
public class IdGeneratingTest {
	...
	private static final String testIdGeneratingClass = IdGeneratingClass.class
			.getCanonicalName();
	...
	/**
	 * Test the IdGeneratingClass for valid rest mapping. Important for
	 * development.
	 */
	@Test
